    ...
    return (
        <div className="currculums">
            ...
            <ul className="curriculum">
                ...
                <li><span>강사명<br/>PROF</span><strong>VICTOR</strong></li>
                <li><span>수강코드<br/>CODE</span><strong>#111000</strong></li>
                <li><span>레벨<br/>NIVEAU</span><strong>B2</strong></li>
                <li><span>진도<br/>PARTIE</span><strong>1 / 4</strong></li>
